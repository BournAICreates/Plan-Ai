                                ...
                                {sortedEvents.map(event => (
                                    <div
                                        ...
                                        style={{
                                            ...
                                            borderRadius: '12px',
                                            borderLeft: `4px solid ${event.isExternal ? '#7c3aed' : 'var(--color-primary)'}`,
                                    ...
                                    >
                                        ...
                                        <div style={{ flex: 1 }}>
                                            ...
                                            {event.isExternal && (
                                                <span style={{ fontSize: '0.7rem', padding: '2px 6px', background: '#f3e8ff', color: '#7c3aed', borderRadius: '4px', marginTop: '6px', display: 'inline-block' }}>
                                                    External
                                                </span>
                                            )}
                                        </div>
